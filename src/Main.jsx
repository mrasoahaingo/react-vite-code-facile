      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
        <div className="relative pt-36 ml-auto">
          <div className="lg:w-2/3 text-center mx-auto">
            <h1 className="tracking-tighter text-white text-5xl md:text-6xl xl:text-7xl">
              <div className="font-black text-transparent text-6xl lg:text-7xl bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">
